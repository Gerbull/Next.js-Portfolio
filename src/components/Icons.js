...
export const DGeraskinLogo = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1.8em"
		height="1.8em"
		...
		<defs>
			<style type="text/css">
				{`
          .fil1 {fill:${mode === 'dark' ? '#262626' : '#f5f5f5'}; opacity:0.5}
          .fil0 {fill:gray; opacity:0.5}
          .fil2 {fill:white; opacity:0.8}
        `}
			</style>
		</defs>
		<g id="Layer_1">
			...
			<polygon
				className="fil0"
				points="19.1,132.35 38.21,121.32 57.31,110.29 57.31,66.17 38.21,55.14 38.21,33.09 19.1,44.12"
			/>
			<polygon
				className="fil1"
				points="76.41,165.43 19.1,132.35 76.41,99.26 133.72,132.35"
			/>
			<path
				className="fil1"
				d="M76.41 121.32l-38.2-22.06 35.81-20.68c2.56,3.66 2.39,13.89 2.39,20.68l19.1 11.03-19.1 11.03z"
			/>
			<polygon
				className="fil2"
				points="19.1,44.12 0,33.09 0,143.37 76.41,187.49 76.41,165.43 19.1,132.35"
			/>
			<polygon
				className="fil2"
				points="76.41,121.32 76.41,143.37 38.21,121.32 38.21,99.26"
			/>
			<path
				className="fil2"
				d="M95.51 110.29l-19.1-11.03c0-22.06 0-22.06-19.1-33.09l-19.1-11.03v-22.05l19.1 11.03c38.2 22.05 38.2 22.05 38.2 66.17z"
			/>
			<polygon
				className="fil0"
				points="76.41,187.49 76.41,165.43 133.72,132.35 133.72,154.4"
			/>
			<path
				className="fil0"
				d="M38.21 33.09l19.1 11.03c38.2 22.05 38.2 22.05 38.2 66.17l-19.1 11.03v22.05l57.31-33.08c0-14.23 0-16.29 0-22.06 0-44.11 0-44.11-38.21-66.17l-38.2-22.06-57.31 33.09 19.1 11.03 19.11-11.03z"
			/>
		</g>
	</svg>
);

export const GithubIconMobile = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1em"
		height="1em"
		...
		<path fill="none" d="M0 0h512v512H0z" />
		<path
			fill={`${mode === 'dark' ? '#1b1b1b' : '#f5f5f5'}`}
			d="M256 32C132.3 32 32 134.9 32 261.7c0 101.5 64.2 187.5 153.2 217.9a17.56 17.56 0 0 0 3.8.4c8.3 0 11.5-6.1 11.5-11.4 0-5.5-.2-19.9-.3-39.1a102.4 102.4 0 0 1-22.6 2.7c-43.1 0-52.9-33.5-52.9-33.5-10.2-26.5-24.9-33.6-24.9-33.6-19.5-13.7-.1-14.1 1.4-14.1h.1c22.5 2 34.3 23.8 34.3 23.8 11.2 19.6 26.2 25.1 39.6 25.1a63 63 0 0 0 25.6-6c2-14.8 7.8-24.9 14.2-30.7-49.7-5.8-102-25.5-102-113.5 0-25.1 8.7-45.6 23-61.6-2.3-5.8-10-29.2 2.2-60.8a18.64 18.64 0 0 1 5-.5c8.1 0 26.4 3.1 56.6 24.1a208.21 208.21 0 0 1 112.2 0c30.2-21 48.5-24.1 56.6-24.1a18.64 18.64 0 0 1 5 .5c12.2 31.6 4.5 55 2.2 60.8 14.3 16.1 23 36.6 23 61.6 0 88.2-52.4 107.6-102.3 113.3 8 7.1 15.2 21.1 15.2 42.5 0 30.7-.3 55.5-.3 63 0 5.4 3.1 11.5 11.4 11.5a19.35 19.35 0 0 0 4-.4C415.9 449.2 480 363.1 480 261.7 480 134.9 379.7 32 256 32Z"
		/>
	</svg>
);

export const TwitterIcon = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1em"
		height="1em"
...
export const TwitterIconMobile = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1em"
		height="1em"
...
export const LinkedInIcon = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1em"
		height="1em"
...
export const LinkedInIconMobile = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="1em"
		height="1em"
...
export const SunIconMobile = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="24"
		height="24"
		...
		className={`w-full h-auto ${className}`}>
		<g
			fill={`${mode === 'dark' ? '#1b1b1b' : '#FFA300'}`}
			stroke={`${mode === 'dark' ? '#1b1b1b' : '#FFA300'}`}
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth="2">
			<g strokeDasharray="2">
		...
		<g fill={`${mode === 'dark' ? '#1b1b1b' : '#FFA300'}`} fillOpacity="0">
			<path d="m15.22 6.03l2.53-1.94L14.56 4L13.5 1l-1.06 3l-3.19.09l2.53 1.94l-.91 3.06l2.63-1.81l2.63 1.81z">
				<animate
					id="lineMdSunnyFilledLoopToMoonFilledLoopTransition0"
					fill="freeze"
...
export const MoonIconMobile = ({ className, mode, ...rest }) => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="24"
		height="24"
		...
		<rect x="0" y="0" width="24" height="24" fill="rgba(255, 255, 255, 0)" />
		<g
			fill={`${mode === 'dark' ? '#ED00FF' : '#00FFF8'}`}
			stroke={`${mode === 'dark' ? '#00FFF8' : '#f5f5f5'}`}
			strokeDasharray="2"
			strokeDashoffset="2"
			strokeLinecap="round"
			strokeWidth="2">
		...
		<g fill={`${mode === 'dark' ? '#2800FF' : '#f5f5f5'}`}>
			<path d="M15.22 6.03L17.75 4.09L14.56 4L13.5 1L12.44 4L9.25 4.09L11.78 6.03L10.87 9.09L13.5 7.28L16.13 9.09L15.22 6.03Z">
				<animate
					fill="freeze"
					attributeName="fill-opacity"
		...
		<mask id="lineMdMoonFilledToSunnyFilledLoopTransition0">
			...
			<circle cx="18" cy="6" r="12" fill="#1b1b1b">
				<animate
					fill="freeze"
					attributeName="cx"
					begin="0.6s"
